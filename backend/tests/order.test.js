...
import { createTestUser, createTestProduct, addToCart } from './helpers/testHelpers.js';
...
describe('Checkout & Orders', () => {
  ...
  describe('POST /api/orders', () => {
    it('should create an order successfully', async () => {
      ...
      expect(['PENDING', 'PROCESSING', 'SHIPPED', 'DELIVERED', 'CANCELLED']).toContain(response.body.data.status);
